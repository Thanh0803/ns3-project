...
int main (int argc, char *argv[])
{
  ...
  numPackets = uint32_t(3600*lambda);
  ...
  std::string file_name = "mm1queue_lambda_"+ std::to_string(static_cast<int>(lambda)) +  ".dat";
  Ptr<OutputStreamWrapper> stream = asciiTraceHelper.CreateFileStream (file_name);
